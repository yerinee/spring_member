							...
							<div class="register-card-body">
								<form id="frm" role="form" class="form-horizontal" method="post" enctype="multipart/form-data"
									...
									<div class="input-group mb-3">
										<div class="mailbox-attachments clearfix" style="text-align: center; width:100%;">
											<div class="mailbox-attachment-icon has-img" id="pictureView" style="border: 1px solid green; height: 200px; width: 140px; margin: 0 auto;">
												<img id ="pictureViewImg" src="${pageContext.request.contextPath }/member/profileImg?userid=${memberVo.userid}"/><br>
											</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9 input-group-sm">
											<input class="form-control" name="pass" type="password" class="form-control" 
													value = "${memberVo.pass}" id="pass" placeholder="비밀번호" />
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9 input-group-sm">
											<input class="form-control" name="usernm" type="text" 
														value = "${memberVo.usernm}" id="usernm" placeholder="이름" />
										</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9 input-group-sm">
											<input class="form-control" name="alias" type="text"
														value = "${memberVo.alias}"  id="alias" placeholder="별명">
										</div>
									</div>
									<div class="form-group row">
										<label for="addr1" class="col-sm-3 control-label">주소</label>
										<div class="col-sm-3 input-group-sm">
											<input name="addr1" type="text" class="form-control" id="addr1" 
														value = "${memberVo.addr1}" placeholder="주소" readonly>
										</div>
										<div class="col-sm-3 input-group-sm">
											<input name="addr2" type="text" class="form-control" id="addr2"
														value = "${memberVo.addr2}" placeholder="상세주소">	
										</div>
									...
									<div class="card-footer">
										<div class="row">
											<div class="col-sm-6">
												<button type="button" id="regBtn" class="btn btn-info">수정</button>
											</div>
