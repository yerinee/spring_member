						...
						<div class="card-footer">
							<nav aria-label="member list Navigation">
								...
								<c:if test="${page > 1 && page <= pages}">
										<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath }/member/memberlist?page=1&pageSize=${pageSize}"><i class="fas fa-angle-double-left"></i></a></li>
										<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath }/member/memberlist?page=${page-1}&pageSize=${pageSize}"><i class="fas fa-angle-left"></i></a></li>
								</c:if>
...
<%-- 												<li class="active"><span>${i }</span></li> --%>
											...
											<c:otherwise>                                                                                                                                                                                                                                                                                                                                   
												<li class="page-item "><a class="page-link" href="${pageContext.request.contextPath }/member/memberlist?page=${i}&pageSize=${pageSize}">${i}</a></li>										
											</c:otherwise>
										</c:choose>
									</c:forEach>
...
<%-- 										<li><span><a href="${pageContext.request.contextPath }/BoardlListServlet?page=${pages}&lbo_id=${lboard.lbo_id}"> >> </a></span></li>									 --%>
										<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath }/member/memberlist?page=${page+1}&pageSize=${pageSize}"><i class="fas fa-angle-right"></i></a></li>
										<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath }/member/memberlist?page=${pages}&pageSize=${pageSize}"><i class="fas fa-angle-double-right"></i></a></li>	
									</c:if>	
